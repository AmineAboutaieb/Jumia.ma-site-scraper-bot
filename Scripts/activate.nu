...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\hp\Desktop\folders\python\jumia-scraper'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\hp\Desktop\folders\python\jumia-scraper\Scripts\deactivate.nu'
